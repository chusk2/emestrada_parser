...
- cálculo del valor de la constante cinética o la velocidad de reacción: se suministran datos de concentraciones o del valor de la velocidad de reacción.
- factores que afectan a la velocidad: una cuestión teórica donde se pregunta qué factores podrían modificar la velocidad de reacción.
...
- grado de disociación (dato): el enunciado suministra como dato, el grado disociación (alfa)
- grado de disociación (pregunta): el enunciado pide calcular el valor del grado disociación (alfa)
- equilibrio heterogéneo: en la ecuación del equilibrio existen especies sólidas o bien líquidas
- equilibrio heterogéneo (cálculos): el ejercicio pide calcular la cantidad de sólido reaccionado o en el equilibrio.
- presiones parciales: se pide calcular las presiones parciales en el equilibrio o bien las suministran como dato.
- tabla en función de alfa: existe un único reactivo gaseoso, no me dan datos de la cantidad de reactivo, es necesario poner la tabla de equilibrio en función de alfa.
- 
- ejercicios donde la solución de x es negativa: usa estos exámenes como referencia
    EJERCICIOS DE EQUILIBRIO QUÍMICO CON SOLUCIÓN NEGATIVA
    Año: 2013, Convocatoria: Junio, Ejercicio: 6, Opción B
    Año: 2012, Convocatoria: Septiembre, Ejercicio: 6, Opción B.
    Año: 2014, Convocatoria: Reserva 2, Ejercicio: 5, Opción B
    Año: 2011, Convocatoria: Reserva 2, Ejercicio: 5, Opción B
    Año: 2017, Convocatoria: Reserva 4, Ejercicio: 5, Opción A

- ecuación de 2do grado: investiga a partir del enunciado del problema si sería necesario usar el valor de Kc ó Kp para obtener el valor de x.